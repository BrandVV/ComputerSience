...
class Login extends StatefulWidget {
  ...
  Login({Key? key, required this.darkmode, required this.autoLogin})
      : super(key: key);
...
class _Login extends State<Login> {
                        ...
                        child: Padding(
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              ...
                              await checkLogin(context, emailController.text,
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                color:
                                    returnDarkmodeButtonColor(widget.darkmode),
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                              ),
                            ),
  ...
  checkLogin(context, username, passwort) async {
    ...
    late String Username, Permission, error;
    print("Start Login");
    if (username != "admin" && passwort != "admin") {
      var a = await authUser(context, username, passwort);
      print("a = " + a);
      userMap = jsonDecode(a);
      Username = userMap['name'];
      Permission = userMap['permissions'];
      error = userMap['error'];
      ...
      if (Username != "") {
        if (Permission != "") {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => UserHome(darkmode: widget.darkmode)));
          //print('Login Erfolg');
        } else {
  ...
  Widget CustomRadioButton(String text, int index) {
    ...
    return OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
        side: BorderSide(color: (value == index) ? Colors.green : Colors.white),
      ),
    );
  }
